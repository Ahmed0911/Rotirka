...
void EtherDriver::Init()
{
    ...
    g_pui8MACAddr[3] = 0x40;
    g_pui8MACAddr[4] = 0x50;
    g_pui8MACAddr[5] = 0x61;


	// lwIP Ethernet
	lwIPInit(g_ui32SysClock, g_pui8MACAddr, inet_addr("123.0.168.192"), inet_addr("0.255.255.255"), inet_addr("1.0.168.192"), IPADDR_USE_STATIC); 	// Set IP
	//lwIPInit(g_ui32SysClock, g_pui8MACAddr, inet_addr("123.20.21.172"), inet_addr("0.255.255.255"), inet_addr("1.40.18.172"), IPADDR_USE_STATIC);   // Set IP
