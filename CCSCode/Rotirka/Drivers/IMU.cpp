...
void IMU::Init(void)
{
	...
	// Initialize the DCM system. 400 hz sample rate, accel weight = .01, gyro weight = .98, mag weight = .01
	CompDCMInit(&m_sCompDCMInst, 1.0f / 400.0f, 0.001f, 0.998f, 0.001f); // TODO: MODIFY!!!!
}
